...
#initialise fpga
vector = [1]*1 + [1]*9 + [0]*15 + [1]*1 + [1]*9 #35 bit vector. 1 enables reading corresponding encoder, 0 disables it.
...
revResolution   = 0             #0 to 8. Bit length of revolution counter representation. When 0, revolution counters are not sent.
